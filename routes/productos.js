...
routerProductos.post('/', (req,res)=>{         // Agrega un producto
    contenedorProductos.guardarItem(req.body)
    res.json('Producto guardado')
})

routerProductos.put('/:id', (req, res) =>{        // Actualiza un producto por su id
...
routerProductos.delete('/:id', (req,res)=>{       // Elimina un producto por su id
